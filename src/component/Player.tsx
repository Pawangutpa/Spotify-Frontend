...
const Player = () => {
  ...
  return (
    <div>
      {song && (
        <div className="h-[10%] bg-black flex justify-betwwn items-center text-white px-4">
          <div className="lg:flex items-center gap-4">
            <img
              src={song.thumbnail ? song.thumbnail : "/music_default.png"}
              className="w-12"
              alt=""
            />
          ...
          <div className="flex flex-col items-center gap-1 m-auto">
            ...
            <div className="flex justify-center items-center gap-4">
              ...
              <button className="bg-white text-black rounded-full p-2" onClick={handlePalyPause}>
          ...
          <div className="flex items-center">
            <input type="range" min={'0'} max={"100"} step={"0.1"} className="w-16 md:w-32" value={volume*100} onChange={volumeChange}/>
          </div>
        </div>
      )}
    </div>
