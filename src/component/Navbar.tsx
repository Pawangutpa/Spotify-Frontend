  ...
  return (
    ...
    <div className="w-full flex justify-between items-center">
      ...
      <div className="flex items-center gap-4">
        <p className="px-4 py-1 cursor-pointer bg-white text-black text-[15px] rounded-full">Expore Premium</p>
        <p className="px-4 py-1 cursor-pointer bg-white text-black text-[15px] rounded-full">Install App</p>
        {
          isAuth?(<p onClick={logouthnadler} className="px-4 py-1 cursor-pointer bg-white text-black text-[15px] rounded-full">Logout</p>):(
            <p onClick={()=>navigate("/login")} className="px-4 py-1 cursor-pointer bg-white text-black text-[15px] rounded-full">Login</p>
          )
        }
